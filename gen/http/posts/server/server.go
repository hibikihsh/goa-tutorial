...
func (s *Server) MethodNames() []string { return posts.MethodNames[:] }
...
// MountListHandler configures the mux to serve the "posts" service "list"
// endpoint.
func MountListHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("GET", "/posts", f)
}

// NewListHandler creates a HTTP handler which loads the HTTP request and calls
// the "posts" service "list" endpoint.
func NewListHandler(
...
// MountShowHandler configures the mux to serve the "posts" service "show"
// endpoint.
...
// the "posts" service "show" endpoint.
func NewShowHandler(
	endpoint goa.Endpoint,
	mux goahttp.Muxer,
	decoder func(*http.Request) goahttp.Decoder,
...
// MountCreateHandler configures the mux to serve the "posts" service "create"
// endpoint.
...
// MountUpdateHandler configures the mux to serve the "posts" service "update"
// endpoint.
...
// MountDeleteHandler configures the mux to serve the "posts" service "delete"
// endpoint.
